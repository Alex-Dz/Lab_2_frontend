  ...
  <div class="col-12 col-sm-10 col-md-8 offset-sm-1 offset-md-2">
    <div class="mt-5">
      <form class="border border-primary rounded form-inline" @submit="create">
        ...
        <h2 class="col-12 text-center text-primary mt-3 mb-5">Asocie su usuario con un nuevo curso</h2>
        ...
        <div class="form-group col-12">
          <label class="custom-label col-md-3 display" for="durationHours">Duración</label>
          <input id="durationHours" class="form-control col-12 col-sm-10 col-md-7 offset-sm-1" type="number"
                 placeholder="Horas" v-model="durationHours" required/>
        </div>
        ...
        axios
          .post( this.$store.state.backURL + path,
            ...
            if( response.status !== 201 ){
              ...
              alert( "Se ha creado y asignado exitosamente el nuevo curso" );
            ...
            if( response.response.status === 401 ){
              ...
              alert( "Verifica el nombre y duración del curso" );
            }else{
